...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    EMAIL_SERVER_USER: process.env.EMAIL_SERVER_USER, // Your Gmail address
    EMAIL_SERVER_PASSWORD: process.env.EMAIL_SERVER_PASSWORD, // Your Gmail app password
    EMAIL_FROM: process.env.EMAIL_FROM, // The "from" email address
  },
  /**
